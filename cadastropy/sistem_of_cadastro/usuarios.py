        ...
        while True:
            ...
            if resposta == "s":
                self.db.salvar_no_banco(
                    self.nome, self.idade, self.cpf, self.endereco,
...
if __name__ == "__main__":
    cadastro_depositores = CadastroDepositores()
    cadastro_depositores.cadastrar()
